            ...
            <div class="container">
                <div class="tabContainer">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="news2.php">Dịch vụ chuyển kho xưởng</a></li>
                        <li><a href="news3.php">Dịch vụ cho thuê xe tải</a></li>
                    </ul>
                </div>
                <div class="tab-content">
                    <div href = "news2.php" class="tab-pane fade in active">
                        ...
                        <main class="mt-5 pt-5">
                            ...
                            $table = 'editor';
                            $result = $mySQL-> query("SELECT COUNT(*) as total FROM $table where $table.type='Dịch vụ chuyển kho xưởng'") or die($mySQL->error);
                            $result_per_page = 5;
                            ...
                            $result = $mySQL -> query("SELECT * FROM $table where $table.type='Dịch vụ chuyển kho xưởng' LIMIT ".$this_page_first_result. ',' .$result_per_page);
...
<!--                                        End tag-->
                   ...
                   <div id="pagin" class="pagination divCenterInner">';
                            if($page>1){
                                $page_num = $page-1;
                                echo '<a href="news2.php?page=' . $page_num . '">' . "&laquo;" . '</a> ';
                            ...
                            for ($i=1;$i<=$num_of_page;$i++) {
                                if($i==$page){
                                    echo '<a class="active" href="news2.php?page=' . $i . '">' . $i . '</a> ';
                                }else{
                                    echo '<a href="news2.php?page=' . $i . '">' . $i . '</a> ';

                                }
                            }
                            if($page<$num_of_page){
                                $page_num = $page+1;
                                echo '<a href="news2.php?page=' . $page_num . '">' . "&raquo;" . '</a> ';
                            }else {
